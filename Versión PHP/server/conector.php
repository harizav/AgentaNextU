	...
	function verifyConexion(){ //Funcion de verificación de conexión
	    ...
	    if( $this->conexion->connect_errno != '0' ){ //Verificar si existe un error al comparar que la respuesta del servidor sea diferente de 0
	      ...
	      if ($this->conexion->connect_errno == "1045" ){ //Verificar que el error sea por error de usuario y/o contraseña a través de la respuesta del servidor numero "1045"
	        $response.="<h6><b>Error de conexión</b></h6><p>Vefirique que los parámetros de conexión <b>username y password </b> del archivo <b>conector.php</b> dentro de la <b>carpeta server</b> del proyecto correspondan a un <b>usuario y contraseña válido de phpmyadmin</b></br>". $this->conexion->connect_error . "\n</p>";
	      }
	      ...
	      $conexion['msg'] =  "<p>Conexión establecida con phpMyadmin</p>"; //Guardar el mensaje si existe un error durante la conexión en el índice "msg"
	    }
